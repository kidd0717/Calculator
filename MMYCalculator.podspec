#
#  Be sure to run `pod spec lint MMYCalculator.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  #  profile URL.
  #
  spec.homepage = "https://github.com/kidd0717/Calculator"

  spec.author             = { "Pei-Yao Ding" => "peiyaoding@meta.com" }
  # Or just: spec.author    = "Pei-Yao Ding"
  # spec.authors            = { "Pei-Yao Ding" => "peiyaoding@meta.com" }
  # spec.social_media_url   = "https://twitter.com/Pei-Yao Ding"
